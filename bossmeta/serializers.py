...
class CoordinateFrameSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('coord_name', 'coord_description', 'xextent', 'yextent', 'zextent', 'xvoxelsize', 'yvoxelsize', 'zvoxelsize')
...
class DatasetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Dataset
        fields = ('dataset_name', 'dataset_description','experiment','is_source','coord_frame', 'datatype','channels','coord')
...
class ExperimentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Experiment
        fields = ('experiment_name', 'experiment_description','collection','num_resolution_levels','heirarchy_method','datasets')
