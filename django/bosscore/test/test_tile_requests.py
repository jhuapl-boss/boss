...
class BossTileRequestTests(APITestCase):
    ...
    def test_request_tile_init_tileargs_time(self):
        ...
        :return:
        """
        url = '/' + version + '/tiles/col1/exp1/channel1/xy/2/0:5/0:6/1/1/'
    ...
    def test_request_tile_invalid_xargs(self):
        ...
        :return:
        """
        url = '/' + version + '/tiles/col1/exp1/channel1/xy/0/990:1010/0:6/1/'
    ...
    def test_request_tile_invalid_yargs(self):
        ...
        :return:
        """
        url = '/' + version + '/tiles/col1/exp1/channel1/xy/0/0:6/0:1010/1/'
    ...
    def test_request_tile_invalid_zargs(self):
        ...
        :return:
        """
        url = '/' + version + '/tiles/col1/exp1/channel1/xy/0/0:6/0:6/1040/'
    ...
    def test_request_tile_invalid_orientation(self):
        ...
        :return:
        """
        url = '/' + version + '/tiles/col1/exp1/channel1/xe/0/0:6/0:6/1/'
