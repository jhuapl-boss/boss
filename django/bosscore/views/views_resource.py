...
class ChannelDetail(APIView):
    ...
    def get(self, request, collection, experiment, channel):
        ...
        try:
            ...
            if channel_obj.id in [325, 326, 331, 333, 334, 338, 339, 373, 374, 375, 376, 377, 378, 379, 380, 381, 382,
                                  ...
                                  1100, 1101, 1102, 1103, 1105, 1106, 1107, 1108, 1109, 1110] or request.user.has_perm("read", channel_obj):
