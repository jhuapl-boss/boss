...
class BoundingBoxRequestTests(APITestCase):
    ...
    def test_cuboids_from_id_service(self):
        """
        Test initialization of cutout requests for the datamodel
        :return:
        """
        url = '/' + version + '/cuboidsfromid/col1/exp1/layer1/0/10'
        col = 'col1'
        exp = 'exp1'
        channel = 'layer1'
        ...
        drfrequest = CuboidsFromID().initialize_request(request)
    ...
    def test_cuboids_from_id_service_invalid_channel_type(self):
        """
        Test initialization of cutout requests for the datamodel
        :return:
        """
        url = '/' + version + '/cuboidsfromid/col1/exp1/channel1/0/10'
        col = 'col1'
        exp = 'exp1'
        channel = 'channel1'
    ...
    def test_cuboids_from_id_service_invalid_resolution(self):
        """
        Test initialization of cutout requests for the datamodel
        :return:
        """
        url = '/' + version + '/cuboidsfromid/col1/exp1/layer1/25/10'
        col = 'col1'
        exp = 'exp1'
        channel = 'layer1'
